...
@Getter
@AllArgsConstructor
public enum TossPaymentException {
    ...
    public boolean isFailure() {
        return switch (this) {
            case ALREADY_PROCESSED_PAYMENT, UNKNOWN, UNKNOWN_PAYMENT_ERROR, PROVIDER_ERROR, CARD_PROCESSING_ERROR,
                 FAILED_INTERNAL_SYSTEM_PROCESSING, FAILED_PAYMENT_INTERNAL_SYSTEM_PROCESSING -> false;
            default -> true;
        };
    }
    ...
    public static TossPaymentException get(String errorCode) {
        return Arrays.stream(TossPaymentException.values())
